<?php
	...
	$defaults = array(
		...
		'box_hover_bg' => esc_attr(gt3_get_theme_option("theme_color"))
	);
	...
	if ($box_hover_bg != '' && $box_hover_bg != gt3_get_theme_option("theme_color")) {
	...
	$compile .= '<div class="gt3_services_box to-'.esc_attr($rotate_direction).' ' . esc_attr($animation_class) . ' ' . esc_attr($item_el_class) . '">
		...
		<a class="gt3_services_box_link" href="'.esc_attr($url).'" '.$title_for_button.' '.$button_target.'>' . esc_html__("View More", "sohopro") . '</a>
	</div>';
