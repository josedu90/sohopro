...
add_action('admin_menu', 'register_license_submenu_page');

function register_license_submenu_page() {
    add_submenu_page( 'themes.php', 'Product Activation', 'Product Activation', 'administrator', 'gt3_activation_submenu_page', 'gt3_activation_submenu_page_callback' ); 
    wp_enqueue_script(
...
function gt3_activation_submenu_page_callback() {
    ...
    echo '<h2 class="gt3_product_activation_title">Product Activation</h2>';
    ...
    echo '<div class="gt3_register__buttons">';
        echo '<a href="javascript:void(0);" class="gt3_register__submit">'.__( 'Activate', 'sohopro' ).'</a>';
        echo '<a href="javascript:void(0);" class="gt3_register__deregister">'.__( 'Deactivate', 'sohopro' ).'</a>';
        echo '<a href="javascript:void(0);" class="gt3_activation_refresh" title="'.__( 'Refresh Activation', 'sohopro' ).'"><i class="dashicons-before dashicons-update" aria-hidden="true"></i></a>';
    echo "</div>";


    if ($gt3_registration_status != 'active') {
        echo '<div class="gt3_info_container">'.__( 'To unlock all theme features and get auto-updates, please activate the theme. Enter your purchase code and click "Activate". Don\'t know where the purchase code is? ', 'sohopro' ).'<a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">'.__( 'Click here.', 'sohopro').'</a>'.'</div>';
    }
    ...
    if ($gt3_registration_status == 'active') {
        ...
        if (get_option( 'gt3_account_attached' ) == 'true') {
            echo "<div class='gt3_support_container gt3_info_container'>";
                echo '<div><strong>'.esc_html( 'The purchase code is linked to your GT3themes account', 'sohopro' ).' </strong></div>';
                echo "<a class='button button-primary' href='https://gt3accounts.com/app' style='color: #71c341;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;'>". esc_html( "Go to Your Account", "sohopro" ) ." </a>";
            echo "</div>";
        }else{
            echo '<div class="gt3_info_container gt3_info_container--no_icon gt3_account_submit_container">';
                echo "<div class='gt3_register__popup_sepparator'><span>".__( 'Next Step', 'sohopro' )."</span></div>";
                echo '<strong style="font-size: 1.4em;color: #121212;">'.__( 'It\'s time to protect your purchase code.', 'sohopro' ).'</strong>';
                ...
                echo "<p>".__( 'Enter your email address to bind the purchase code. We will create a customer account for you by using your email address.', 'sohopro' )."</p>";
                echo "<div>".__( 'After that, you will be able to:', 'sohopro' )."</div>";
                echo "<ul>
                    <li>".__( 'View where your purchase code is used.', 'sohopro' )."</li>
                    <li>".__( 'Manage all your purchase codes.', 'sohopro' )."</li>
                    <li>".__( 'Check for product and support status.', 'sohopro' )."</li>
                </ul>";
                ...
                $newsletter_value = '';
                echo '<a href="javascript:void(0);" class="gt3_account_submit">'.__( 'Protect & Create Account', 'sohopro' ).'</a>';
            echo "</div>";
        }
        ...
        if (function_exists('gt3_get_support_time_left')) {
            ...
            if (!empty($support_time_left['time_to_left'])) {
                ...
                echo '<div><a class="button button-primary" href="'. $theme_link .'" style="color: #71c341;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;">'. esc_html( "Update Support Package", "sohopro" ) .' <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a></div>';
                echo "</div>";
            }
        }
    }
    ...
    echo "<div class='gt3_register__popup'>";
        echo "<div class='gt3_register__popup_container'>";
            ...
            echo '<div class="gt3_info_container gt3_info_container--no_icon gt3_account_submit_success_container">';
                echo '<strong style="font-size: 1.4em;color: #121212;">'.__( 'Hey!', 'sohopro' ).'</strong>';
                echo "<p>".__( 'Your account has been successfully created and its details were sent your e-mail address ', 'sohopro' )."<strong class='gt3_account_emai_holder'></strong></p>";
                echo "<p>".__( 'You can log into your account at', 'sohopro' ).' <a href="https://gt3accounts.com/app">gt3accounts.com</a> '.__( 'to manage your purchase code(s) and get dedicated support.', 'sohopro' )."</p>";
                echo "<p>".__( "If you haven't received your account details, please contact us at", 'sohopro' ).' <a href="mailto:help@gt3themes.com">help@gt3themes.com</a> '.__( "and our support team will assist you.", 'sohopro' )."</p>";
                echo "<p><strong>".__( "Thank you for choosing our product.", 'sohopro' )."</strong></p>";
                echo "<div class='gt3_account_submit_success_button'>".__( "Close", 'sohopro' )."</div>";
            echo "</div>";
        echo "</div>";
...
function gt3_get_product_name (){
    $product = 'Creative Portfolio WordPress Theme - SOHO Pro';
    return $product;
}
...
function gt3_account_activation($code = '',$email = ''){
    ...
    if (!empty($email)) {
        ...
        if ( $response_code != 200 || is_wp_error( $version_info ) ) {
            $errore_return = new WP_Error( 'registration-error-connection-error', esc_html__( 'Registration Connection error', 'sohopro' ) );
            return json_encode($errore_return);
        }
    }else{
        $errore_return = new WP_Error( 'registration-error-invalid-email', esc_html__( 'Please provide a valid email address.', 'sohopro' ) );
        return json_encode($errore_return);
    }
...
function gt3_registration_notice() {
  ...
  <div class="notice notice-error" style="background-color: #d54e21; color: #ffffff; border-radius: 4px; padding: 10px 25px 10px 75px;position: relative;border-left: none;">
    ...
    <p style="font-size: 1.4em;font-weight: 500;margin-bottom: 0;"><?php esc_html_e( 'Purchase Validation! Please activate your theme.', 'sohopro' ); ?></p>
    <div style="margin-bottom: 10px;"><a class="button button-primary" href="admin.php?page=gt3_activation_submenu_page" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Register Now', 'sohopro' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a> <a target="_blank" class="button button-primary" href="http://themeforest.net/cart/add_items?item_ids=20151221&ref=gt3themes" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Buy Theme', 'sohopro' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a></div>
  </div>
  <?php
}
...
function gt3_registration_notice_supported_until() {
  ...
  ?>
    <div class="notice notice-error is-dismissible" style="background-color: #d54e21; color: #ffffff; border-radius: 4px; padding: 10px 25px 10px 75px;position: relative;border-left: none;">
        ...
        if (!empty($support_time_left['expired']) && $support_time_left['expired'] == true) {
            esc_html_e( 'Your support package for this theme expired', 'sohopro' ); ?><?php echo " ( ".$support_time_left['time_to_left']." ".esc_html( 'ago', 'sohopro' )." ).";
        }else{
            esc_html_e( 'Your support package for this theme is about to expire', 'sohopro' ); ?><?php echo " ( ".$support_time_left['time_to_left']." ".esc_html( 'left', 'sohopro' )." )."; 
        }     
        ?></p>
        <div style="margin-bottom: 10px;"><a class="button button-primary" href="<?php echo (($theme_link)); ?>" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Update Support Package', 'sohopro' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a> <a class="button button-primary" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'gt3-hide-notice', 'notice_srart' ), 'gt3_hide_notices_nonce', '_gt3_notice_nonce' ) ); ?>" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Dismiss this notice', 'sohopro' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a></div>
    </div>
  <?php
    }
}
...
function gt3_hide_notice (){
    if ( isset( $_GET['gt3-hide-notice'] ) && isset( $_GET['_gt3_notice_nonce'] ) ) {
        if ( ! wp_verify_nonce( $_GET['_gt3_notice_nonce'], 'gt3_hide_notices_nonce' ) ) {
            wp_die( __( 'Action failed. Please refresh the page and retry.', 'sohopro' ) );
        }
...
function gt3_account_notice(){    
  ...
  <div class="notice notice-warning" style="padding: 10px">
    <p><strong><?php esc_html_e( 'Create account and manage your theme purchase codes.', 'sohopro' ) ?></strong></p>
    <p><strong><a href="admin.php?page=gt3_activation_submenu_page"><?php esc_html_e( 'Register Now', 'sohopro' ); ?></a> |  <a href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'gt3-hide-notice', 'account_notice_srart' ), 'gt3_hide_notices_nonce', '_gt3_notice_nonce' ) ); ?>"><?php esc_html_e( 'Dismiss this notice', 'sohopro' ); ?></a></strong></p>
  </div>
  <?php
}
...
if (!function_exists('gt3_first_init')) {
    function gt3_first_init(){
...
add_action( 'after_setup_theme', 'gt3_first_init' );