...
if (function_exists('vc_map')) {
    vc_map(array(
        'base' => 'gt3_blog_grid',
        'name' => esc_html__('Blog Grid', 'sohopro'),
        "description" => esc_html__("Displays your posts in masonry layout", "sohopro"),
    ...
    class WPBakeryShortCode_GT3_Blog_Grid extends WPBakeryShortCode
    {
    }
}