...
if (function_exists('vc_map')) {
    vc_map(array(
        'base' => 'gt3_portfolio_grid',
        'name' => esc_html__('Portfolio Grid', 'sohopro'),
        "description" => esc_html__("Displays portfolio posts in grid layout", "sohopro"),
        ...
        'params' => array(
            ...
            array(
                'type' => 'dropdown',
                'heading' => esc_html__('Title Layout', 'sohopro'),
                'param_name' => 'title_layout',
                'admin_label' => true,
				'std' => 'hover',
                'value' => array(
					esc_html__("Show on Hover", "sohopro") => 'hover',
    ...
    class WPBakeryShortCode_GT3_Portfolio_Grid extends WPBakeryShortCode
    {
    }
}