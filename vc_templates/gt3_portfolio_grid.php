...
wp_enqueue_script('portfolio_grid_gallery', get_template_directory_uri() . '/js/portfolio_gallery.js', array(), false, true);
...
if ($gt3_category !== '') {
	...
	?> 
	<div class="gt3_portfolio_grid <?php echo esc_attr($custom_class); ?> <?php echo esc_attr($css_class); ?>" 
        ...
        data-hover = "<?php echo esc_attr($title_layout); ?>"
	    ...
	    <div class="gt3_portfolio_grid_inner <?php echo esc_attr($custom_class); ?> <?php echo esc_attr($css_class); ?> masonry_is_<?php echo esc_attr($masonry); ?> portfolio_grid_columns<?php echo esc_attr($items_in_row); ?>" 
	        data-pad="<?php echo esc_attr($items_padding); ?>" 
            data-perload="<?php echo esc_attr($items_per_load); ?>">
		<?php
			...
			while ($gt3_wp_query_in_shortcodes->have_posts()) : $gt3_wp_query_in_shortcodes->the_post();				
				...
				if ($title_layout == 'hover') {
				?>
                <div class="portfolio_grid_item title_layout_<?php echo (($title_layout)); ?> anim_el anim_el2 loading portfolio_grid_block2preload element <?php echo (($echoallterm2)); ?>" data-category="<?php echo esc_attr($echoallterm2); ?>">
			...
			if ($ajax == 'on') {
				echo "
					<div class='gt3_grid_module_button gt3_portfolio_grid_module_button'>
						<a class='portfolio_grid_load_more gt3_soho_button' href='". esc_js("javascript:void(0)") ."'><span>" . esc_attr($button_title) . "</span></a>
					</div>";
			}
		?>
	</div>
